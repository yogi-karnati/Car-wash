    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                ...
                <ul className="navbar-nav cent">
                    <li className="nav-item active">
                        <a className="nav-link" href="/admin/addlocation">
                            Add Locations<span className="sr-only"></span>
                        </a>
                    </li>
                </ul>
                <ul className="navbar-nav cent">
                    <li className="nav-item active">
                        <a className="nav-link" href="/admin/addserv">
                            Add Services<span className="sr-only"></span>
                        </a>
                    </li>
                </ul>
            </div>
